  ...
  const sections: Section[] = [
      ...
      content: (
        <ul className="list-disc pl-6 space-y-2">
          <li>
            ...
            <a
              href="http://www.sourcingscreen.com"
          ...
          <li>
            Registered users including recruiters, vendors, hiring companies,
            and other authorized users;
          </li>
          <li>
            Personal data collected during the course of our recruitment
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                ...
                Name, email, mobile number, company name, designation, business
              ...
              <li>
                ...
                Candidate names, contact details, resumes, experience, skills,
                and other information submitted by recruiters or vendors.
              </li>
              <li>
                <span className="font-medium text-gray-300">
                  Hiring Requirements:
                </span>{" "}
                Job descriptions, hiring budgets, screening questions,
                preferences, and related documentation.
              </li>
              <li>
                <span className="font-medium text-gray-300">
                  Communication Data:
                </span>{" "}
                Messages, emails, and responses exchanged on the Platform.
              </li>
              <li>
                <span className="font-medium text-gray-300">
                  Billing and Payment Information:
                </span>{" "}
                If applicable, we may collect PAN, GSTIN, bank details, and
                transaction records.
              </li>
            </ul>
          </div>
    ...
    },
    {
      ...
      content: (
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            To connect employers with recruiters and facilitate candidate
            submissions;
          </li>
          <li>
            To communicate with you regarding jobs, submissions, offers,
            payments, and other platform activity;
          </li>
          <li>To comply with legal obligations and regulatory requirements;</li>
          <li>
            To enhance the Platform, perform analytics, and prevent fraud;
          </li>
    ...
    },
    {
      ...
      content: (
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <span className="font-medium text-gray-300">Consent:</span> Where
            you have given explicit consent (e.g., marketing communications).
          </li>
          <li>
            <span className="font-medium text-gray-300">
              Contractual Necessity:
            </span>{" "}
            To fulfill our obligations under the service agreement.
          </li>
          <li>
            <span className="font-medium text-gray-300">
              Legitimate Interest:
            </span>{" "}
            To ensure the smooth operation and improvement of our services.
          </li>
          <li>
            <span className="font-medium text-gray-300">Legal Obligation:</span>{" "}
      ...
      content: (
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <span className="font-medium text-gray-300">
                Hiring companies and recruiters/vendors
              </span>{" "}
            ...
            <li>
              ...
              Cloud hosting, analytics, payment processors, background
          ...
          <p className="font-medium text-gray-200">
            We <span className="underline">do not</span> sell your personal data
            to third parties.
          </p>
        </div>
      ),
    },
    {
      ...
      content: (
        <p>
          Your data may be processed and stored in countries outside of your
          own, including countries that may not offer the same level of data
          protection. In such cases, we ensure appropriate safeguards are in
          place, such as contractual clauses or adequacy decisions under
          applicable laws.
        </p>
      ),
    },
      ...
      content: (
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              Right to deletion (subject to contractual and legal obligations);
            </li>
          ...
          <p>
            ...
            <a
              href="mailto:privacy@sourcingscreen.com"
              className="text-indigo-400 hover:text-indigo-300"
            >
              privacy@sourcingscreen.com
            </a>
          </p>
        </div>
      ),
    ...
    },
    {
      ...
      content: (
        <p>
          ...
          on this page with an updated "Last Updated" date. Your continued use
          of the Platform constitutes your acceptance of the updated policy.
        </p>
      ),
    },
    {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <p className="text-gray-300 leading-relaxed">
              Welcome to{" "}
              <span className="font-bold text-white">SourcingScreen.com</span>{" "}
              ("we," "us," or "our"). Your privacy is important to us. This
              Privacy Policy explains how we collect, use, share, and protect
              your personal data when you use our website, platform, and related
            ...
            <p className="mt-4 text-gray-300 leading-relaxed">
              ...
              (EU), and other international privacy frameworks.
            </p>
          </motion.div>
          ...
          >
            <p className="text-gray-400 mb-6">
              Have more questions about our Privacy Policy or how we handle your
              data?
            </p>
