        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.linkedin.com/company/sourcingscreen1" className="text-gray-400 hover:text-white" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://www.facebook.com/sourcingscreen" className="text-gray-400 hover:text-white" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://x.com/SourcingScreen" className="text-gray-400 hover:text-white" target="_blank" rel="noopener noreferrer">
